    ...
    [[nodiscard]] std::string elementToString(const Element &element) const {
        ...
        if (useColor) {
            if (element.indicatorLevel < 0) {
                ss << R"("color": "#)"
                   << std::setw(2) << std::setfill('0') << std::hex << (int) negative.r
                   << std::setw(2) << std::setfill('0') << std::hex << (int) negative.g
                   << std::setw(2) << std::setfill('0') << std::hex << (int) negative.b
                   << "\"\n";
            } else if (element.indicatorLevel == 0) {
                ss << R"("color": "#)"
                   << std::setw(2) << std::setfill('0') << std::hex << (int) neutral.r
                   << std::setw(2) << std::setfill('0') << std::hex << (int) neutral.g
                   << std::setw(2) << std::setfill('0') << std::hex << (int) neutral.b
                   << "\"\n";
            } else if (element.indicatorLevel > 0) {
                ss << R"("color": "#)"
                   << std::setw(2) << std::setfill('0') << std::hex << (int) positive.r
                   << std::setw(2) << std::setfill('0') << std::hex << (int) positive.g
                   << std::setw(2) << std::setfill('0') << std::hex << (int) positive.b
                   << "\"\n";
            }
        }
